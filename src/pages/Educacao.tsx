    ...
    <Layout>
      ...
      {/* Calendar Event Modal */}
        ...
        <button
          ...
          className="fixed bottom-56 right-6 w-14 h-14 bg-secondary text-secondary-foreground rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform z-40"
